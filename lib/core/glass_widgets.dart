...
class GlassButton extends StatelessWidget {
  ...
  const GlassButton({
    ...
    this.minimumSize = const Size(64.0, 36.0),
    this.enabled = true,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: backgroundColor.withValues(alpha: enabled ? opacity : opacity * 0.5),
        borderRadius: BorderRadius.circular(borderRadius),
        boxShadow: [
          BoxShadow(
            color: Colors.white.withValues(alpha: 0.2),
              ...
              child: Container(
                ...
                child: Center(
                  child: Theme(
                    data: Theme.of(context).copyWith(
                      textTheme: Theme.of(context).textTheme.apply(
                        bodyColor: enabled ? foregroundColor : foregroundColor.withValues(alpha: 0.5),
                        displayColor: enabled ? foregroundColor : foregroundColor.withValues(alpha: 0.5),
                      ),
                      iconTheme: IconThemeData(
                        color: enabled ? foregroundColor : foregroundColor.withValues(alpha: 0.5),
                      ),
                    ),
                    child: DefaultTextStyle(
                      style: TextStyle(
        ...
        child: BackdropFilter(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: widget.foregroundColor.withOpacity(0.7)),
              labelText: widget.labelText,
              labelStyle: TextStyle(color: widget.foregroundColor.withOpacity(0.7)),
